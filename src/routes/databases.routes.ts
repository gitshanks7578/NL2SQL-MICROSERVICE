...
import { execute, query, register_database_mysql, register_database_postgres, registerUser, schema_injestion } from "../controller/database.controller.js";
...
database_router.post("/execute",verifyjwt,execute)
